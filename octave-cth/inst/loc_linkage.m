...
## dale: fixed an error in the warning string, you need a namespace:id
## or else it won't print the warning.
function dgram = loc_linkage (d, method = "single", distarg)
