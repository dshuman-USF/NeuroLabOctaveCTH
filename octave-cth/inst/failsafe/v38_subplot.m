...
## This is the 3.8 version of subplot.  The 4.0 and later, up to 4.2 version is
## badly broken for more than a small number of subplots.  E.g., bar charts are
## upside down, text is in the wrong place, scaling is wrong.
## --dale Update comment Tue Jul 11 2017
## --dale Thu Sep 17 2015
## function h = subplot (varargin)
function h = v38_subplot (varargin)
